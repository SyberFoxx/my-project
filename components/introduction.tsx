            ...
            <div className='z-20 grid items-center h-full p-6 py-20 md:py-0 md:grid-cols-2'>
                ...
                <div className='flex flex-col justify-center max-w-md'>
                    ...
                    <p className='mx-auto mb-2 text-xl md:mx-0 md:mb-8'>
                        Como dessarrollador frontend, me dedico a combinar diseño y funcionalidad para crear experiencias digitales impactantes y accesibles
                    </p>
                    ...
                    <div className='flex item-center justify-center gap-3 md:justify-start md:gap-10'>
                        ...
                        href="/contact" 
                        className='px-3 py-2 transition-all border-2 cursor-pointer 
                        text-secondary border-secondary text-md w-fit rounded-xl hover:shadow-xl hover:shadow-secondary'>
                            Contacta conmigo
                        </Link>  
                    </div>
