...
const TimeLine = () => {
    return (
        <div className="flex flex-col justifi center divide-y divide-slate-200">
                        ...
                        <div key={data.id} className="relative py-6 pl-8 sm:pl-32 group">
                            ...
                            <div className="flex flex-col sm:flex-row items-start mb-1 
                                ...
                                <time className="sm:absolute left-0 translate-y-0.5 inline-flex items-center
                                    justify-center text-xs font-semibold uppercase w-20 h-6 mb-3 sm:mb-0 text-esmerald-600 bg-esmerald-100
                                    rounded-full
